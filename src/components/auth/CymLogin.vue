...
<template>
    <div
        class="index bg-gradient-to-t from-blue-500 to-blue-300 h-screen grid justify-items-center content-center"
    >
        <div
            class="bg-[#fff] rounded-lg shadow-2xl justify-items-center"
            style="width: 850px; height: 500px"
        >
            <div class="flex h-full">
                <div class="h-full w-1/2 pt-14 pl-10 pr-10">
                    <div
                        class="content-center leading-[50px] w-full mt-10 text-center text-[30px]"
                    >欢迎单位会员登录</div>
                    <div class="pt-3">
                        <input
                            v-model="forms.user"
                ...
                <div class="h-full w-1/2 bg-green-700 rounded-r-lg">
                    ...
                    <div
                        class="content text-gray-200 p-4 border-1 border-t border-solid border-blue-gray-800"
                    >
                        ...
                        <div
                            class="inline-block align-text-bottom mt-1"
                        >5、联系电话: 0851-88173437、0851-88173059。</div>
                        ...
                        <div>
                            ...
                            <p
                                class="inline-block align-text-bottom ml-6 mt-1"
                            >账 号: 521145000018010005402</p>
                        </div>
                    </div>
                </div>
            </div>
...
const emits = defineEmits(['loginFun', 'codeFun'])
const myBackground = ref(null);
const forms = reactive({ user: "", pwd: "", code: "" });
...
const getNewCode = () => {
    if (code_img.code_key == "") {
        ...
        GET_CODE({ code_key: code_img.code_key });
    }
};
const GET_CODE = (data = {}) => {
